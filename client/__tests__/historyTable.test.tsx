...
const mockFetchHelper: jest.Mock<Promise<any>> = jest.fn(() =>
  Promise.resolve({
    Items: [{ timeHour: Date.now(), temperature: 70, humidity: 50 }],
  })
);
      ...
      render(
        <AppContext.Provider value={mockAppContext}>
          <AccountContext.Provider
            value={{ ...mockAccountContextValue, fetchHelper: mockFetchHelper }}
          >
            <HistoryTable />
          </AccountContext.Provider>
        </AppContext.Provider>
