  ...
  it('renders Room component correctly', () => {
    ...
    const { getByText } = render(
      <AppContext.Provider value={mockAppContext}>
        <AccountContext.Provider value={mockAccountContextValue}> {/* Include this line if AccountContext is used */}
          <Room room={mockRoom} buildingName="MockBuilding" rowIndex={0} colIndex={0} />
